...
from datasets.part_259.dataset import PoseDataset as PoseDataset_exo
...
parser.add_argument('--dataset_root', type=str, default = './datasets/part_259/259_preprocessed', help='dataset root dir')
parser.add_argument('--model', type=str, default = 'trained_models/exo_259/test_same_as_train/pose_model_34_0.01076121904738434.pth',  help='resume PoseNet model')
parser.add_argument('--refine_model', type=str, default = 'trained_models/exo_259/test_same_as_train/pose_refine_model_290_0.005862721607850279.pth',  help='resume PoseRefineNet model')
...
if __name__ == '__main__':
    ...
    opt.objlist = [1]
    bs = 1
    dataset_config_dir = 'datasets/part_259/dataset_config'
    ...
    #if opt.mode == "eval":
    #    testdataset = PoseDataset_exo('eval', opt.num_points, True, opt.dataset_root, 0.0, True)
    #else:
    testdataset = PoseDataset_exo(opt.mode, opt.num_points, True, opt.dataset_root, 0.0, True)
    ...
    for i, data in enumerate(testdataloader, 0):
        ...
        print("Predicted rotation: "+str(my_R))   # [ 0.31085131  0.39842421 -0.01708576 -0.86275007]
        ...
        if (vis_bbox == True):
            ...
            #image = visualize_labels(image, mask, ori_label_path[i])       # Fait rien pour le moment

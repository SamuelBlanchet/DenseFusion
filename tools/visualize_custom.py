...
parser.add_argument('--mode', type=str, default = 'eval',  help='Choose mode: eval or show_gt')
opt = parser.parse_args()
####

exo = {'num_obj': 7, 'dataset_root': './datasets/exo/Exo_preprocessed', 'dataset_config_dir':'datasets/exo/dataset_config'}
linemod = {'num_obj': 15, 'dataset_root': './datasets/linemod/Linemod_preprocessed', 'dataset_config_dir':'datasets/linemod/dataset_config'}

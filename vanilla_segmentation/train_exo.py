...
from data_controller import SegDataset_Exo
...
parser.add_argument('--dataset_root', default='/home/Documents/SBlanchet/AI/DenseFusion/datasets/exo/Exo_Preprocessed', help="dataset root dir (''LineMOD'')")
...
if __name__ == '__main__':
    ...
    dataset = SegDataset_Exo(opt.dataset_root, '../datasets/exo/Exo_preprocessed/data/train.txt', True, 5000)
    dataloader = torch.utils.data.DataLoader(dataset, batch_size=opt.batch_size, shuffle=True, num_workers=int(opt.workers))
    test_dataset = SegDataset_Exo(opt.dataset_root, '../datasets/exo/dataset_config/test_data_list.txt', False, 1000)
